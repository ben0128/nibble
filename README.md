...
Lightweight, zero-dependency Logitech mouse control for macOS. Single 530 KB binary. No daemon, no telemetry, no account.

**Site:** [nibble-45j.pages.dev](https://nibble-45j.pages.dev)

> G HUB is a 4 GB install. Nibble is 530 KB.
...
- The **General** tab writes to the mouse as you change it. Tick *Re-apply my settings at login* and whatever you set is remembered automatically — there is no separate save step. The **Save** button at the bottom right belongs to the Buttons tab, where edits are staged.
